...
/**
 * Represents settable properties that effect how Xuggler objects<br>
 * operate.<br>
 * <p><br>
...
public class IProperty extends RefCounted {
  ...
  /**
   * The different type of options that are supported by Xuggler.<br>
   * <br>
  ...
  public enum Type {
    ...
    PROPERTY_BOOL(XugglerJNI.IProperty_PROPERTY_BOOL_get()),
  ...
  public enum Flags {
    ...
    FLAG_FILTERING_PARAM(XugglerJNI.IProperty_FLAG_FILTERING_PARAM_get());
