...
/**
 * Time (duration) values with units.<br>
 * This class also has methods<br>
 * that correctly account for long wrapping when comparing time values.<br>
...
public class ITimeValue extends RefCounted {
  ...
  /**
   * Make a new time value.<br>
   * @param value The value.<br>
   * @param unit The unit value is expressed in.<br>
  ...
  /**
   * Make a copy of a time value from another time value.<br>
   * @param src The time value to copy.  If 0 this method returns 0.<br>
   * @return a new time value.
   */
  ...
  /**
   * Get the value of this ITimeValue, in the specified Unit.<br>
   * @param unit The unit you want to get a value as.<br>
  ...
  /**
   * Compare this timeValue to another.<br>
   * This compareTo will compare the values, but will assume that the values<br>
   * can never be more than half of int64_t's MAX_VALUE apart.  If they are<br>
   * it will assume long wrapping has occurred.  This is required especially<br>
   * if you're using TimeValue's as absolute time stamps, and want to know<br>
   * which is earlier.<br>
   * @param other the value to compare to<br>
  ...
  /**
   * Convenience method that calls a.compareTo(b).<br>
   * @see #compareTo<br>
  ...
  /**
   * And another convenience method that deals with un-unitted long values.<br>
   * @param a the first object.<br>
   * @param b the second object.<br>
