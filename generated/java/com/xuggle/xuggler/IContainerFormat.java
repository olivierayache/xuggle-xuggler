...
/**
 * Specifies format information than can be used to configure<br>
 * an {IContainer} for input or output.<br>
 * <p><br>
 * Often times XUGGLER can guess the correct formats to put into<br>
 * a given IContainer object, but sometimes it needs help.  You<br>
 * can allocate an IContainerFormat object and specify information about<br>
 * input or output containers, and then pass this to IContainer.open(...)<br>
 * to help us guess.<br>
 * </p>
 */
...
/**
  ...
  /**
   * Sets the input format for this container.<br>
   * <br>
   * @param shortName The short name for this container (using FFMPEG's<br>
   *   short name).<br>
  ...
  /**
   * Sets the output format for this container.<br>
   * <br>
   * We'll look at the shortName, url and mimeType and try to guess<br>
   * a valid output container format.<br>
   * <br>
   * @param shortName The short name for this container (using FFMPEG's<br>
   *   short name).<br>
   * @param url The URL for this container.<br>
   * @param mimeType The mime type for this container.<br>
  ...
  /**
   * Get the short name for the input format.<br>
  ...
  /**
   * Get the long name for the input format.<br>
  ...
  /**
   * Get the short name for the output format.<br>
  ...
  /**
   * Get the long name for the output format.<br>
  ...
  /**
   * Get the mime type for the output format.<br>
  ...
  /**
   * Create a new IContainerFormat object.<br>
   * <br>
  ...
  /**
   * Get the input flags associated with this object.<br>
   * <br>
  ...
  /**
   * Set the input flags to use with this object.  All values<br>
  ...
  /**
   * Get the input setting for the specified flag<br>
   * <br>
  ...
  /**
   * Get the output flags associated with this object.<br>
   * <br>
   * @return The (compacted) value of all flags set.
   */
  ...
  /**
   * Set the output flags to use with this object.  All values<br>
   * must be ORed (|) together.<br>
   * <br>
   * @see Flags<br>
   * <br>
  ...
  /**
   * Get the output setting for the specified flag<br>
   * <br>
   * @param flag The flag you want to find the setting for<br>
   * <br>
   * @return 0 for false; non-zero for true
  ...
  /**
   * Is this an output container format?<br>
   * <br>
  ...
  /**
   * Is this an input container format?<br>
   * <br>
  ...
  /**
   * Get the filename extensions that this output format prefers<br>
   * (most common first).<br>
   * <br>
   * @return a command separated string of output extensions, or<br>
   *   null if none.
   */
  ...
  /**
   * Get the default audio codec this container prefers, if known.<br>
   * <br>
   * @return the default audio codec id, or {ICodec.ID#CODEC_ID_NONE}<br>
   *   if unknown.
   */
  ...
  /**
   * Get the default video codec this container prefers, if known.<br>
   * <br>
   * @return the default video codec id, or {ICodec.ID#CODEC_ID_NONE}<br>
   *   if unknown.
   */
  ...
  /**
   * Get the default subtitle codec this container prefers, if known.<br>
   * <br>
   * @return the default subtitle codec id, or {ICodec.ID#CODEC_ID_NONE}<br>
   *   if unknown.
   */
  ...
  /**
   * Gets the number of different codecs this container<br>
   * can include for encoding.<br>
   * <br>
   * This can be used as an upper bound when using the<br>
   * {#getOutputCodecID(int)} and<br>
   * {#getOutputCodecTag(int)}<br>
   * methods to dynamically query the actual codecs.<br>
   * <br>
   * @return The total number of different codec types that can<br>
  ...
  /**
   * Queries for a supported codec id from the list of codecs<br>
   * that can be encoded into this ContainerFormat.<br>
   * <br>
   * @param index The index in our lookup table.  Index &gt;= 0 and<br>
   *   &lt; {#getOutputNumCodecsSupported()}.  Index values may<br>
   *   change between releases, so always query.<br>
   * <br>
   * @return The codec id at this position, or<br>
   *   {ICodec.ID#CODEC_ID_NONE}<br>
   *   if there is none.
   */
  ...
  /**
   * Queries for a supported codec tag from the list of codecs<br>
   * that can be encoded into this ContainerFormat.<br>
   * <p><br>
   * Tags are 4-byte values that are often used as markers<br>
   * in a container format for a codec type.<br>
   * </p><br>
   * @param index The index in our lookup table.  Index &gt;= 0 and<br>
   *   &lt; {#getOutputNumCodecsSupported()}.  Index values may<br>
   *   change between releases, so always query.<br>
  ...
  /**
   * Get the 4-byte tag the container would output for<br>
   * the given codec id.<br>
   * <br>
   * @param id the codec you are about<br>
   * <br>
   * @return the 4-byte codec tag, or 0 if that id is not<br>
   *   supported. 
   */
  ...
  /**
   * Returns true if this container format can output media<br>
   * encoded with the given codec.<br>
   * <br>
   * @param id the codec you care about.<br>
   * <br>
   * @return true if the codec can be put in this output container;<br>
   *   false otherwise.
   */
  ...
  /**
   * Get the number of output formats this install can multiplex <br>
   * (write) to.<br>
   * <br>
   * @return the number of formats
   */
  ...
  /**
   * Return an object for the output format at the given index.<br>
   * <br>
   * @param index an index for the output format list we maintain<br>
   * <br>
   * @return a format object for that output or null if<br>
