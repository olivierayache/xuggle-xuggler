 ...
 * </p><br>
 * <p><br>
 * To make an IBuffer object that is not a Xuggler internal object,<br>
...
public class IBuffer extends RefCounted {
   ...
   * <br>
   * @param requestor An optional value telling the IBuffer class what object requested it.  This is used for debugging memory leaks; it's a marker for the FERRY object (e.g. IPacket) that actually requested the buffer.  If you're not an FERRY object, pass in null here.<br>
   ...
   * {IBuffer} objects can be cast to and from any type.<br>
   * </p><br>
   * @return the type  
   */
   ...
   * {Type#IBUFFER_UINT8} to {Type#IBUFFER_SINT16}<br>
   ...
   * </p><br>
   * <br>
   * @param offset The offset (in bytes) into the buffer managed by this IBuffer<br>
   ...
   * <br>
   * @return A copy of the data that is in this IBuffer, or null<br>
   *   if error.
   */
  ...
  /**
   * Allocate a new IBuffer, and copy the data in buffer into<br>
   * the new IBuffer object.<br>
   * <br>
   * @param requestor An optional value telling the IBuffer class<br>
   ...
   * <br>
   * @return a new IBuffer object with a copy of the data in buffer,<br>
   *   or null on failure.
   */
  ...
  /**
   * Create a new IBuffer object that uses the direct byte buffer<br>
   ...
   *   directByteBuffer.<br>
   * <br>
   * @return a new IBuffer object that is using directByteBuffer<br>
